        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#" id="notifikasi">
                <ion-icon name="notifications-sharp"></ion-icon>
                    <span style="font-size:9px" id="notificationCount" class="badge badge-danger navbar-badge"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right"  style="width:5150px !important;overflow-y: auto ;max-height: 400px" id="notificationBody" >
