...
<head>
    ...
    <body>
        <div class="container" style="text-align:center">
            ...
            <table class="table-stepper" style="width: 100%;font-size:14px;margin-top:10px">
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 1% !important">:  {{$getTicket->problemTypeName->name}}</td>
                    <td style="width: 14%;margin-top:30px !important"></td>
                </tr>
                <tr>
            ...
            <table style="width:100%;font-size:9px;">
                <tr>
                    <td style="width:12.5%">Detail Activity</td>
                    <td style="width:1%">:</td>
                    <td style="width:86.5%"></td>
                </tr>
            </table>
                ...
                <tbody>
                    @forelse ($getTicket->detailWORelation as $item)
                        @if($item->status_wo > 0){
                            ...
                            @endphp
                            <tr>
                                <td style="width:15%;text-align:center">{{$detailDate}} {{$detailTime}}</td>
            ...
            @endphp
            <div class="container">
                <p style="font-size: 9px;text-align:right;margin-bottom:5px"> {{$splitName[1]}}, {{date('F d Y')}}</p>
               <table style="width: 100%;font-size:9px;">
                   <tr>
                       <td style="width: 13%;text-align:center"> Dibuat</td>
                       <td style="width:20%"></td>
               ...
               <table style="width: 100%;font-size:9px;margin-top:70px">
                   <tr>
                       <td style="width: 13%;text-align:center"> {{$getTicket->picName->name}}</td>
                       <td style="width:20%"></td>
                       <td style="width: 33%;text-align:center">{{$getTicket->picSupportName->name}}</td>
                       <td style="width:20%"></td>
