        ...
        <div class="modal-content">
            ...
            <div class="modal-body mx-2 my-2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select name="edit_select_aspek" class="select2" id="edit_select_aspek"></select>
                            <input type="hidden" class="form-control" id="id">
                            <input type="hidden" class="form-control" id="edit_aspek_id">
                            <span class="message_error text-danger edit_aspek_id_error"></span>
                        </div>
                    </div>
            ...
            <div class="modal-footer justify-content-end">
                <button id="btn_update_module" type="button" class="btn btn-success">
